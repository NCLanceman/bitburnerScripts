...
export async function main(ns) {
  ...
  //With this script we peg the amount of money the server has at the beginning
  //then make sure we continue to reap if it's not below 80% of the beginning number.
  const serverTopCash = ns.getServerMoneyAvailable(target)
