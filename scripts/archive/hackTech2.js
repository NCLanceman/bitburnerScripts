...
export async function main(ns) {
    ...
    ns.print("Applying hackTech to server " + target)

    // Defines how much money a server should have before we hack it
    // Get within 20% of the max
    const moneyMax = ns.getServerMaxMoney(target);
    const moneyThresh = moneyMax - (moneyMax * 0.2);
    ...
    const securityThresh = securityMin + (securityMin * 0.2);
